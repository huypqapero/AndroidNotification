package com.kohuyn.notification.notify

import android.annotation.TargetApi
import android.os.Build
import androidx.core.app.NotificationCompat
import com.kohuyn.notification.notify.entities.Payload
import com.kohuyn.notification.notify.internal.RawNotification
import com.kohuyn.notification.notify.internal.utils.Action
import com.kohuyn.notification.notify.internal.utils.Errors
import com.kohuyn.notification.notify.internal.utils.Experimental
import com.kohuyn.notification.notify.internal.utils.NotifyScopeMarker
...
class NotifyCreator internal constructor(private val notify: Notify) {
    ...
    @Deprecated(
        ...
        replaceWith = ReplaceWith(
            "Notify.show()",
            "com.kohuyn.notification.notify.Notify"
        )
    )
    fun show(id: Int?): Int {
    ...
    @Deprecated(
        ...
        replaceWith = ReplaceWith(
            ...
            "android.content.Context", "com.kohuyn.notification.notify.Notify"
        )
    )
